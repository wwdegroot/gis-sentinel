...
export class SentinelSocket{
    ...
    test() {
        setInterval(() => {
            ...
            this.alerts = [
                { id: "id1", atype: "New" as AlertType, name: "test1", performance: 500, expected: 300, reason: "slow performance", up: true},
                { id: "id2", atype: "New" as AlertType,  name: "test2", performance: 100, expected: 100, reason: "No response, 404", up: false},
                { id: "id3", atype: "New" as AlertType,  name: "test3", performance: 150, expected: 150, reason: "Service Unaivalable, 503", up: true},
                { id: "id4", atype: "New" as AlertType, name: "test4", performance: 350, expected: 100, reason: "slow performance", up: true}
            ]
        }, 2000);
    }
